...
import com.mycompany.restfullexample.Actor;
 ...
 */
@Stateless
@Path("com.mycompany.restfullexample.actor")
public class ActorFacadeREST extends AbstractFacade<Actor> {

    @PersistenceContext(unitName = "com.mycompany_RestfullExample_war_1.0-SNAPSHOTPU")
